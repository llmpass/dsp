...
class Pfacc {
   ...
   */
  static bool nfftValid(int nfft) {
    return binarySearch(_ntable,NTABLE,nfft)>=0;
  }
  ...
  static int nfftSmall(int n) {
    ...
    int itable = binarySearch(_ntable,NTABLE,n);
  ...
  static int nfftFast(int n) {
    //Check.argument(n<=720720,"n does not exceed 720720");
    int ifast = binarySearch(_ntable,NTABLE,n);
  ...
  //private:
  static void pfa2(float* z, int m, int j0, int j1) {
    for (int i=0; i<m; ++i) {
      float t1r = z[j0  ]-z[j1  ];
  ...
  static void pfa3(float* z, int mu, int m, int j0, int j1, int j2) {
    float c1;
    if (mu==1) c1 =  P866;
    else c1 = -P866;
    for (int i=0; i<m; ++i) {
  ...
  static void pfa4(float* z, int mu, int m, int j0, int j1, int j2, int j3) {
    float c1;
    if (mu==1) c1 =  PONE;
    else c1 = -PONE;
    for (int i=0; i<m; ++i) {
  ...
  static void pfa5(float* z, int mu, int m, 
  ...
  static void pfa7(float* z, int mu, int m,
  ...
  static void pfa8(float* z, int mu, int m,
  ...
  static void pfa9(float* z, int mu, int m,
  ...
  static void pfa11(float* z, int mu, int m,
  ...
  static void pfa13(float* z, int mu, int m,
    int j0, int j1, int j2, int j3, int j4, int j5, int j6, 
  ...
  static void pfa16(float* z, int mu, int m,
    int j0, int j1, int j2, int j3, int j4, int j5, int j6, int j7, int j8, 
  ...
  static void pfa2a(int n1, float** z, int m, int j0, int j1) {
    int m1 = 2*n1;
    for (int i=0; i<m; ++i) {
      float* zj0 = z[j0];
      float* zj1 = z[j1];
  ...
  static void pfa3a(int n1, float** z, int mu, int m, 
  ...
  static void pfa4a(int n1, float** z, int mu, int m,
  ...
  static void pfa5a(int n1, float** z, int mu, int m,
    int j0, int j1, int j2, int j3, int j4)
  {
    int m1 = 2*n1;
    float c1,c2,c3;
  ...
  static void pfa7a(int n1, float** z, int mu, int m,
    int j0, int j1, int j2, int j3, int j4, int j5, int j6)
  {
    int m1 = 2*n1;
    float c1,c2,c3,c4,c5,c6;
  ...
  static void pfa8a(int n1, float** z, int mu, int m,
    int j0, int j1, int j2, int j3, int j4, int j5, int j6, int j7) {
    int m1 = 2*n1;
    float c1,c2,c3;
    if (mu==1) {
  ...
  static void pfa9a(int n1, float** z, int mu, int m,
    int j0, int j1, int j2, int j3, int j4, int j5, int j6, int j7, int j8) {
    int m1 = 2*n1;
    float c1,c2,c3,c4,c5,c6,c7,c8,c9;
    if (mu==1) {
  ...
  static void pfa11a(int n1, float** z, int mu, int m,
    int j0, int j1, int j2, int j3, int j4, int j5, 
    int j6, int j7, int j8, int j9, int j10) {
    int m1 = 2*n1;
    float c1,c2,c3,c4,c5,c6,c7,c8,c9,c10;
  ...
  static void pfa13a(int n1, float** z, int mu, int m,
    int j0, int j1, int j2, int j3, int j4, int j5, int j6, 
    int j7, int j8, int j9, int j10, int j11, int j12) {
    int m1 = 2*n1;
    float c1,c2,c3,c4,c5,c6,c7,c8,c9,c10,c11,c12;
  ...
  static void pfa16a(int n1, float** z, int mu, int m,
    int j0, int j1, int j2, int j3, int j4, int j5, int j6, int j7, int j8, 
    int j9, int j10, int j11, int j12, int j13, int j14, int j15) {
    int m1 = 2*n1;
    float c1,c2,c3,c4,c5,c6,c7;
  ...
  static void pfa2b(int n1, float** z, int m, int j0, int j1) {
    for (int i=0; i<m; ++i) {
      float* zj0r = z[j0  ];
      float* zj0i = z[j0+1];
      float* zj1r = z[j1  ];
  ...
  static void pfa3b(int n1, float** z, int mu, 
    int m, int j0, int j1, int j2) {
    float c1;
    if (mu==1) c1 =  P866;
    else c1 = -P866;
    for (int i=0; i<m; ++i) {
  ...
  static void pfa4b(int n1, float** z, int mu, int m,
    int j0, int j1, int j2, int j3) {
    float c1;
    if (mu==1) c1 =  PONE;
    else c1 = -PONE;
  ...
  static void pfa5b(int n1, float** z, int mu, int m,
    int j0, int j1, int j2, int j3, int j4) {
    float c1,c2,c3;
    if (mu==1) {
      c1 =  P559;
  ...
  static void pfa7b(int n1, float** z, int mu, int m,
    int j0, int j1, int j2, int j3, int j4, int j5, int j6) {
    float c1,c2,c3,c4,c5,c6;
    if (mu==1) {
      c1 =  P623;
  ...
  static void pfa8b(int n1, float** z, int mu, int m,
    int j0, int j1, int j2, int j3, int j4, int j5, int j6, int j7) {
    float c1,c2,c3;
    if (mu==1) {
      c1 =  PONE;
  ...
  static void pfa9b(int n1, float** z, int mu, int m,
    int j0, int j1, int j2, int j3, int j4, int j5, int j6, int j7, int j8) {
    float c1,c2,c3,c4,c5,c6,c7,c8,c9;
    if (mu==1) {
      c1 =  P866;
  ...
  static void pfa11b(int n1, float** z, int mu, int m,
    int j0, int j1, int j2, int j3, int j4, int j5, 
    int j6, int j7, int j8, int j9, int j10) {
    float c1,c2,c3,c4,c5,c6,c7,c8,c9,c10;
    if (mu==1) {
  ...
  static void pfa13b(int n1, float** z, int mu, int m,
    int j0, int j1, int j2, int j3, int j4, int j5, int j6, 
    int j7, int j8, int j9, int j10, int j11, int j12) {
    float c1,c2,c3,c4,c5,c6,c7,c8,c9,c10,c11,c12;
    if (mu==1) {
  ...
  static void pfa16b(int n1, float** z, int mu, int m,
    int j0, int j1, int j2, int j3, int j4, int j5, int j6, int j7, int j8, 
    int j9, int j10, int j11, int j12, int j13, int j14, int j15) {
    float c1,c2,c3,c4,c5,c6,c7;
    if (mu==1) {
  ...
  static int _kfac[10]; // = {16, 13, 11, 9, 8, 7, 5, 4, 3, 2};
  ...
  static const int NTABLE = 240;
  static int _ntable[NTABLE];
  ...
  static double _ctable[NTABLE];
};


const float Pfacc::P120; 
const float Pfacc::P142; 
const float Pfacc::P173;
const float Pfacc::P222;
const float Pfacc::P239;
const float Pfacc::P281;
const float Pfacc::P342;
const float Pfacc::P354;
const float Pfacc::P382;
const float Pfacc::P415;
const float Pfacc::P433;
const float Pfacc::P464;
const float Pfacc::P540;
const float Pfacc::P559;
const float Pfacc::P568;
const float Pfacc::P587;
const float Pfacc::P623;
const float Pfacc::P642; 
const float Pfacc::P654; 
const float Pfacc::P663;
const float Pfacc::P707;
const float Pfacc::P748;
const float Pfacc::P755;
const float Pfacc::P766;
const float Pfacc::P781;
const float Pfacc::P822;
const float Pfacc::P841;;
const float Pfacc::P866;
const float Pfacc::P885;
const float Pfacc::P900;
const float Pfacc::P909;
const float Pfacc::P923;
const float Pfacc::P935;
const float Pfacc::P939;
const float Pfacc::P951;
const float Pfacc::P959;
const float Pfacc::P970;
const float Pfacc::P974;
const float Pfacc::P984;
const float Pfacc::P989;
const float Pfacc::P992;
const float Pfacc::PONE;

const int Pfacc::NFAC;

int Pfacc::_kfac[10] = {16, 13, 11, 9, 8, 7, 5, 4, 3, 2};
int Pfacc::_ntable[NTABLE] = {
         1, 2, 3, 4, 5, 6, 7, 8, 9, 
