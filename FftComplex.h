#ifndef _FFTCOMPLEX_H
#define _FFTCOMPLEX_H
...
class FftComplex {
  ...
  void complexToComplex1(int sign, int n2, int n3, float*** cx, float*** cy) {
    ...
    for (int i3=0; i3<n3; ++i3) complexToComplex1(sign,n2,cx[i3],cy[i3]);
  }
  ...
  void complexToComplex2(int sign, int n1, int n3, float*** cx, float*** cy) {
    ...
    for (int i3=0; i3<n3; ++i3) complexToComplex2(sign,n1,cx[i3],cy[i3]);
  }
  ...
  void scale(int n1, int n2, float** cx) {
    for (int i2=0; i2<n2; ++i2) scale(n1,cx[i2]);
  }
  ...
  void scale(int n1, int n2, int n3, float*** cx) {
    for (int i3=0; i3<n3; ++i3) scale(n1,n2,cx[i3]);
  }
